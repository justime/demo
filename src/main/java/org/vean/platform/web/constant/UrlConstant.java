package org.vean.platform.web.constant;

public final class UrlConstant{
    public static final String GET_USER_BY_ACCOUNT="/getUserByAccount";
    public static final String USER_PREFIX="/user";
    public static final String TEST_PREFIX="/test";
    public static final String TEST_SECURE_HTTP_INVOKER="/testSecureHttpInvoker";
    ...
    public static final String TEST_MULTI_DataSource="/testMultiDataSource";
